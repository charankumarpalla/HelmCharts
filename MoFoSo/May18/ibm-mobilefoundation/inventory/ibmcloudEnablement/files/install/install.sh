...
#
# export _SYSGEN_DOCKER_REGISTRY="cp.icr.io"
# export _SYSGEN_DOCKER_REGISTRY_USER="ekey"
# export _SYSGEN_DOCKER_REGISTRY_PASSWORD="agSP4KevZD3WaMprHlGfWm0kf2nKrEPrzrVX6pnfV2c4"
...
echo -e "===============>>\n\n2.Values : \n\t_SYSGEN_DOCKER_REGISTRY:$_SYSGEN_DOCKER_REGISTRY \n\t_SYSGEN_DOCKER_REGISTRY_USER:$_SYSGEN_DOCKER_REGISTRY_USER\n\t_SYSGEN_DOCKER_REGISTRY_PASSWORD:$_SYSGEN_DOCKER_REGISTRY_PASSWORD"
echo -e "oc create secret docker-registry ${_GEN_IMG_PULLSECRET} -n ${_SYSGEN_MF_NAMESPACE} --docker-server=${_SYSGEN_DOCKER_REGISTRY} --docker-username=${_SYSGEN_DOCKER_REGISTRY_USER} --docker-password=${_SYSGEN_DOCKER_REGISTRY_PASSWORD}"

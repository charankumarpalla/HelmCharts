...
echo "Generating the server console login secret ... "
...
echo "Generating the analytics console login secret ... "
...
echo "Generating the application center console login secret ... "
